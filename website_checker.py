...
def _extract_phone(html: str) -> str:
    # Only trust explicit tel: links — anything else (scanning raw page text
    # for digit sequences) produces false positives like IP addresses,
    # tracking IDs, coordinates, and prices, which is worse than no data.
